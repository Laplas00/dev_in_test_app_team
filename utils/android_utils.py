...
elements_id = {
        ...
        'sidebar_home'                  : '@resource-id="com.ajaxsystems:id/compose_menu"',
        ...
        'sms_language_field'            : '@resource-id="com.ajaxsystems:id/title" and @text="SMS language:"',
        ...
        'appereance_button'             : '@resource-id="com.ajaxsystems:id/appSettingsAppearance"',
        'selected_theme'                : '@resource-id="com.ajaxsystems:id/selected"',
        'theme_item0'                   : '@resource-id="item0"',
        'theme_item1'                   : '@resource-id="item1"',
        'theme_item2'                   : '@resource-id="item2"',

        'measurement_unit_chose'        : '@resource-id="com.ajaxsystems:id/title" and @text="Measurement system"',
        'measurement_unit0'             : '@resource-id="com.ajaxsystems:id/textView" and @text="Imperial/US customary"',
